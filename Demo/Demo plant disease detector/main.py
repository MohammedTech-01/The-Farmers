    ...
    while True:
        ...
        if current_message != previous_message:  # Check if there is a new alert or heal message
            ...
            if current_message:
                ...
                elif current_message.startswith("The plant"):
                ...
                alert_placeholder.info("No disease detected")  # Display a default message if the file is empty
...
st.write("Monitoring plant health...")
